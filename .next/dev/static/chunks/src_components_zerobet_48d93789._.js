...
"[project]/src/components/zerobet/screens/JournalScreen.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JournalScreen() {
    ...
    const { journalEntries, addJournalEntry, deleteJournalEntry, navigate, plan, addXP, completeQuest, dailyQuests, streakDays, journalUsage, consumeJournalEntry } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    // Helper bound to the current language — used both for calendar weekday
    // headers and for the entry date footer.
    const formatWeekday = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "JournalScreen.useCallback[formatWeekday]": (d)=>getWeekdayShort(d, language)
    }["JournalScreen.useCallback[formatWeekday]"], [
        language
    ]);
    const [showNewEntry, setShowNewEntry] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [content, setContent] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [emotion, setEmotion] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("calm");
    ...
    // Weekly analysis
    const weeklyStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JournalScreen.useMemo[weeklyStats]": ()=>{
            const weekAgo = Date.now() - 7 * 24 * 3600 * 1000;
            const recent = journalEntries.filter({
                "JournalScreen.useMemo[weeklyStats].recent": (e)=>new Date(e.createdAt).getTime() > weekAgo
            }["JournalScreen.useMemo[weeklyStats].recent"]);
            const counts = {
                frustrated: 0,
                strong: 0,
                tempted: 0,
            ...
            recent.forEach({
                "JournalScreen.useMemo[weeklyStats]": (e)=>{
                    counts[e.emotion]++;
                }
            }["JournalScreen.useMemo[weeklyStats]"]);
    ...
    const calendarDays = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JournalScreen.useMemo[calendarDays]": ()=>{
            const days = [];
            for(let i = 6; i >= 0; i--){
                const dayDate = getDaysAgo(i);
                const dayStr = dayDate.toDateString();
                const entries = journalEntries.filter({
                    "JournalScreen.useMemo[calendarDays].entries": (e)=>new Date(e.createdAt).toDateString() === dayStr
                }["JournalScreen.useMemo[calendarDays].entries"]);
                const isToday = i === 0;
                ...
                if (entries.length > 0) {
                    const emotionCounts = {};
                    entries.forEach({
                        "JournalScreen.useMemo[calendarDays]": (e)=>{
                            emotionCounts[e.emotion] = (emotionCounts[e.emotion] || 0) + 1;
                        }
                    }["JournalScreen.useMemo[calendarDays]"]);
                    const dominant = Object.entries(emotionCounts).sort({
                        "JournalScreen.useMemo[calendarDays]": (a, b)=>b[1] - a[1]
                    }["JournalScreen.useMemo[calendarDays]"])[0];
                    if (dominant) {
                        const emoData = EMOTIONS.find({
                            "JournalScreen.useMemo[calendarDays].emoData": (em)=>em.key === dominant[0]
                        }["JournalScreen.useMemo[calendarDays].emoData"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: calendarDays.map((day)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        entry.trigger && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: EMOTIONS.map((emo)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(JournalScreen, "FyIbpp5Y2TWKRNqILBaIieM22zA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$useT$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useT"],
...
_c = JournalScreen;
var _c;
__turbopack_context__.k.register(_c, "JournalScreen");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/zerobet/screens/JournalScreen.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/zerobet/screens/JournalScreen.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=src_components_zerobet_48d93789._.js.map