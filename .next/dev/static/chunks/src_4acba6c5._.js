...
"[project]/src/components/zerobet/screens/TriggersScreen.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(CountUp, "LqVgM2nChIDHKlKGhZLoRfuoM+U=");
_c = CountUp;
function TriggersScreen() {
    ...
    const navigate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "TriggersScreen.useStore[navigate]": (s)=>s.navigate
    }["TriggersScreen.useStore[navigate]"]);
    const plan = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "TriggersScreen.useStore[plan]": (s)=>s.plan
    }["TriggersScreen.useStore[plan]"]);
    const triggers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "TriggersScreen.useStore[triggers]": (s)=>s.triggers
    }["TriggersScreen.useStore[triggers]"]);
    const addTrigger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "TriggersScreen.useStore[addTrigger]": (s)=>s.addTrigger
    }["TriggersScreen.useStore[addTrigger]"]);
    const deleteTrigger = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$zerobet$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])({
        "TriggersScreen.useStore[deleteTrigger]": (s)=>s.deleteTrigger
    }["TriggersScreen.useStore[deleteTrigger]"]);
    const isPremium = plan !== "free";
    // Modal & UI state
    const [modalOpen, setModalOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [filterTab, setFilterTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("7d");
    ...
    const [copingMethod, setCopingMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(COPING_METHODS[0].key);
    const [resisted, setResisted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // ---------- Derived data ----------
    const weekAgoMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[weekAgoMs]": ()=>Date.now() - 7 * 86_400_000
    }["TriggersScreen.useMemo[weekAgoMs]"], []);
    const triggersThisWeek = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[triggersThisWeek]": ()=>triggers.filter({
                "TriggersScreen.useMemo[triggersThisWeek]": (t)=>new Date(t.createdAt).getTime() >= weekAgoMs
            }["TriggersScreen.useMemo[triggersThisWeek]"])
    }["TriggersScreen.useMemo[triggersThisWeek]"], [
        triggers,
        weekAgoMs
    ]);
    const topCategory = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[topCategory]": ()=>{
            const counts = {};
            triggersThisWeek.forEach({
                "TriggersScreen.useMemo[topCategory]": (t)=>{
                    counts[t.category] = (counts[t.category] || 0) + 1;
                }
            }["TriggersScreen.useMemo[topCategory]"]);
            const entries = Object.entries(counts).sort({
                "TriggersScreen.useMemo[topCategory].entries": (a, b)=>b[1] - a[1]
            }["TriggersScreen.useMemo[topCategory].entries"]);
    ...
    const resistanceRate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[resistanceRate]": ()=>{
            if (triggersThisWeek.length === 0) return 0;
            const resistedCount = triggersThisWeek.filter({
                "TriggersScreen.useMemo[resistanceRate]": (t)=>t.resisted
            }["TriggersScreen.useMemo[resistanceRate]"]).length;
    ...
    const filterCounts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[filterCounts]": ()=>{
            return FILTER_TABS.map({
                "TriggersScreen.useMemo[filterCounts]": (t)=>{
                    ...
                    return {
                        ...
                        count: triggers.filter({
                            "TriggersScreen.useMemo[filterCounts]": (tr)=>new Date(tr.createdAt).getTime() >= cutoff
                        }["TriggersScreen.useMemo[filterCounts]"]).length
                    };
                }
            }["TriggersScreen.useMemo[filterCounts]"]);
        }
    ...
    const filteredTriggers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[filteredTriggers]": ()=>{
            const activeTab = FILTER_TABS.find({
                "TriggersScreen.useMemo[filteredTriggers].activeTab": (t)=>t.id === filterTab
            }["TriggersScreen.useMemo[filteredTriggers].activeTab"]);
            if (!activeTab || activeTab.days === null) return triggers;
            const cutoff = Date.now() - activeTab.days * 86_400_000;
            return triggers.filter({
                "TriggersScreen.useMemo[filteredTriggers]": (t)=>new Date(t.createdAt).getTime() >= cutoff
            }["TriggersScreen.useMemo[filteredTriggers]"]);
        }
    }["TriggersScreen.useMemo[filteredTriggers]"], [
        triggers,
    ...
    const insights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[insights]": ()=>{
            if (triggersThisWeek.length === 0) return null;
            // 1. Most frequent trigger
            const catCounts = {};
            triggersThisWeek.forEach({
                "TriggersScreen.useMemo[insights]": (t)=>{
                    catCounts[t.category] = (catCounts[t.category] || 0) + 1;
                }
            }["TriggersScreen.useMemo[insights]"]);
            const sortedCats = Object.entries(catCounts).sort({
                "TriggersScreen.useMemo[insights].sortedCats": (a, b)=>b[1] - a[1]
            }["TriggersScreen.useMemo[insights].sortedCats"]);
            ...
            const sortedTod = Object.values(todCounts).sort({
                "TriggersScreen.useMemo[insights].sortedTod": (a, b)=>b.count - a.count
            }["TriggersScreen.useMemo[insights].sortedTod"]);
            ...
            const sortedCoping = Object.entries(copingStats).map({
                "TriggersScreen.useMemo[insights].sortedCoping": ([k, v])=>({
                        method: k,
                        rate: Math.round(v.resisted / v.total * 100),
                        total: v.total
                    })
            }["TriggersScreen.useMemo[insights].sortedCoping"]).sort({
                "TriggersScreen.useMemo[insights].sortedCoping": (a, b)=>b.rate - a.rate
            }["TriggersScreen.useMemo[insights].sortedCoping"]);
    ...
    const heatMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[heatMap]": ()=>{
            const days = [];
            for(let i = 29; i >= 0; i--){
                const d = new Date();
                ...
                const count = triggers.filter({
                    "TriggersScreen.useMemo[heatMap]": (t)=>new Date(t.createdAt).toDateString() === dayStr
                }["TriggersScreen.useMemo[heatMap]"]).length;
                days.push({
                    date: d,
                    count,
    ...
    const aiInsightText = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TriggersScreen.useMemo[aiInsightText]": ()=>{
    ...
    const handleSave = ()=>{
        if (!category || situation.trim().length < 5) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t("triggersEmptyDesc"), {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("triggersSaveBtn"), {
    ...
    const handleDelete = (id)=>{
        if (confirmingId === id) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("triggersEmptyTitle"));
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatBlock, {
                                    ...
                                    value: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CountUp, {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(StatBlock, {
                                    ...
                                    value: topCategory ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-2xl",
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    trig.resisted ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                        ...
                        children: [
                            ...
                            insights ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-3",
                                children: [
                                    insights.topCat && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InsightRow, {
                                    ...
                                    insights.topTod && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InsightRow, {
                                    ...
                                    insights.topCoping && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InsightRow, {
                                        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"],
                                        color: "#FFC94D",
...
_s1(TriggersScreen, "+QVr0tLSbkI+FaHNw/9Envc9MhA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$i18n$2f$useT$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useT"],
...
__turbopack_context__.k.register(_c1, "TriggersScreen");
__turbopack_context__.k.register(_c2, "StatBlock");
__turbopack_context__.k.register(_c3, "InsightRow");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/zerobet/screens/TriggersScreen.tsx [app-client] (ecmascript, next/dynamic entry)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/components/zerobet/screens/TriggersScreen.tsx [app-client] (ecmascript)"));
}),
]);

//# sourceMappingURL=src_4acba6c5._.js.map