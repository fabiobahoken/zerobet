      ...
      <div className="flex-1 flex flex-col justify-center gap-6 max-w-sm mx-auto w-full">
        <motion.button
          ...
          className={`relative glass-card p-8 flex flex-col items-center transition-all ${
            gender === "male" ? "ring-2 ring-[#64D2FF] glow-blue" : ""
          }`}
        >
          {gender === "male" && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="absolute top-4 right-4 w-7 h-7 rounded-full bg-[#64D2FF] flex items-center justify-center"
            >
          ...
          <div
            ...
            style={{ ["--icon-color" as string]: "#64D2FF" }}
          >
            <MaleIcon size={120} />
          </div>
