...
const fr: Dict = {
  ...
  homeMilestoneNext: "Prochaine étape",
  homeMilestoneIn: "dans {n} j",
  homeMilestoneMax: "Objectif ultime atteint",
  statsMiniStreak: "Série",
  statsMiniSaved: "Épargne",
  statsMiniLevel: "Niveau",
  financeGoalDaysLeft: "Objectif dans {n} j",
  financeAddToGoal: "Ajouter à un objectif",
  financeAmountToAdd: "Montant à ajouter",
  financeBeforeVsAfter: "Avant / Après",
  financeBudgetUpdatedToast: "Budget mis à jour",
  financeBudgetWeekly: "Budget hebdomadaire",
  financeCategoryRent: "Loyer",
  financeContributeTitle: "Contribuer à ton objectif",
  financeContributedToast: "Contribution ajoutée",
  financeCreateFirstGoal: "Créer mon premier objectif",
  financeCreateGoal: "Nouvel objectif",
  financeGoalAddedToast: "Objectif créé",
  financeGoalDeletedToast: "Objectif supprimé",
  financeGoalNameRequired: "Donne un nom à ton objectif",
  financeGoalReachedXP: "Objectif d'épargne atteint",
  financeGoalReachedToast: "Bravo, objectif atteint !",
  financeIcon: "Icône",
  financeIncome: "Revenus",
  financeInvalidAmount: "Montant invalide",
  financeMyGoals: "Mes objectifs",
  financeNewGoalTitle: "Nouvel objectif",
  financeNoGoalSet: "Aucun objectif pour l'instant. Fixe-toi un montant et regarde ton épargne le remplir.",
  financeProgress30Days: "Progression sur 30 jours",
  financeReached: "atteints",
  financeSavingsDistribution: "Répartition de l'épargne",
  financeSavingsStreak: "Série d'épargne",
  financeUnderstood: "Compris",
  meditationBravo: "Bravo !",
  meditationBreathingDoneDesc: "Ta séance est terminée. Ton esprit est plus calme, ton cerveau te remercie.",
  meditationBreathingHint: "Respire avec le cercle : inspire en grandissant, expire en rétrécissant.",
  meditationCycleProgress: "Cycle {current} sur {total}",
  meditationGuidedHint: "Laisse-toi guider, respire à ton rythme.",
  meditationMuscleDesc: "Chaque séance renforce le muscle de ta volonté.",
  meditationPaused: "En pause — reprends quand tu veux",
  meditationResumePrompt: "Reprends quand tu es prêt",
  meditationWhyMeditate: "Pourquoi méditer ?",
  notifDeniedToast: "Notifications refusées — active-les dans les réglages",
  notifEnabledToast: "Notifications activées",
  communityReserve: "Parler à un professionnel",
  profileActivities: "{n} activité(s)",
  legalBackToApp: "Retour à l'app",
  legalZerobetFooter: "Zerobet — Jouer moins, vivre plus",
  privacyTitle: "Politique de confidentialité",
  privacySubtitle: "Comment Zerobet protège tes données",
  privacyBadge: "100% privé",
  privacySection1Title: "Données stockées sur ton téléphone",
  privacySection1Body1: "Zerobet est conçu pour que tes données restent chez toi. Toutes tes informations — série, journal, humeur, finances — sont enregistrées directement sur ton appareil.",
  privacySection1Body2: "Nous n'avons accès à aucun de ces contenus.",
  privacySection1Item1: "Aucune donnée personnelle n'est vendue",
  privacySection1Item2: "Aucun pisteur publicitaire",
  privacySection1Item3: "Aucun compte requis",
  privacySection1Item4: "Fonctionne hors ligne",
  privacySection2Title: "Sauvegarde cloud optionnelle",
  privacySection2Body1: "Si tu actives la synchronisation, un identifiant aléatoire non lié à ton identité sauvegarde ta progression.",
  privacySection2Body2: "Tu peux désactiver la synchronisation et effacer les données serveur à tout moment depuis Paramètres → Mes données.",
  privacySection3Title: "Ce que nous partageons",
  privacySection3Body1: "Rien. Aucune donnée n'est cédée à des tiers, à des annonceurs ou à des courtiers en données.",
  privacySection3Body2: "La communauté n'affiche que le pseudo que tu choisis.",
  privacySection4Title: "Cookies et traceurs",
  privacySection4Body1: "Zerobet n'utilise ni cookies publicitaires ni traceurs tiers. Seul un stockage local technique conserve tes préférences.",
  privacySection5Title: "Tes droits",
  privacySection5Body1: "Conformément au RGPD, tu disposes de droits sur tes données :",
  privacySection5Item1: "Accès et export de toutes tes données",
  privacySection5Item2: "Rectification depuis l'application",
  privacySection5Item3: "Effacement immédiat et définitif",
  privacySection5Item4: "Portabilité via l'archive JSON",
  privacySection6Title: "Nous contacter",
  privacySection6Body1: "Une question sur ta vie privée ? Écris-nous, on répond sous 48 h.",
  termsTitle: "Conditions d'utilisation",
  termsSubtitle: "Les règles du jeu — en clair",
  termsBadge: "Édition 2026",
  termsSection1Title: "Objet du service",
  termsSection1Body1: "Zerobet est un outil d'accompagnement pour réduire ou arrêter les paris sportifs. Il ne remplace ni un avis médical ni un traitement professionnel.",
  termsSection1Body2: "En cas de souffrance importante, consulte un professionnel de santé.",
  termsSection2Title: "Utilisation de l'application",
  termsSection2Body1: "En utilisant Zerobet, tu t'engages à utiliser l'application de bonne foi :",
  termsSection2Item1: "Ne pas contourner les outils de blocage",
  termsSection2Item2: "Respecter les autres membres de la communauté",
  termsSection2Item3: "Ne pas utiliser l'app à des fins illégales",
  termsSection2Item4: "Garder un pseudo respectueux",
  termsSection3Title: "Santé et sécurité",
  termsSection3Body1: "Les statistiques affichées sont des estimations basées sur tes saisies et ne constituent pas un diagnostic.",
  termsSection3Body2: "En cas de crise, contacte une ligne d'écoute locale ou un proche de confiance.",
  termsSection4Title: "Abonnements et paiements",
  termsSection4Body1: "L'abonnement premium est mensuel ou annuel, renouvelable, résiliable à tout moment depuis l'écran Abonnement.",
  termsSection4Body2: "Les paiements sont traités par des prestataires locaux (Orange Money, MTN, Wave, CinetPay). Zerobet ne stocke aucun code secret.",
  termsSection5Title: "Responsabilité",
  termsSection5Body1: "Zerobet est fourni « en l'état », sans garantie de résultat. L'application ne peut être tenue responsable des décisions prises indépendamment de son accompagnement.",
  termsSection5Body2: "Zerobet est un projet indépendant, sans lien avec les opérateurs de paris cités.",
  statsConsistency: "Régularité",
  statsCrisesAvoided: "Crises évitées",
  statsCrisis: "crise",
  statsCumulativeSavings: "Épargne cumulée",
  statsDay: "jour",
  statsDaysAgo: "il y a {n} j",
  statsDaysWithMood: "Jours avec humeur",
  statsDaysWithoutBet: "Jours sans pari",
  statsEmotionCount: "{n} émotion(s)",
  statsEntries: "entrées",
  statsEntry: "entrée",
  statsHeatmap: "Calendrier de série",
  statsEmotionDistribution: "Répartition des émotions",
  statsHoursAgo: "il y a {n} h",
  statsJournalEntries: "Entrées de journal",
  ...
  statsMinutesAgo: "il y a {n} min",
  statsNextRank: "Prochain rang",
  statsNoBet: "Sans pari",
  statsNoEmotionDesc: "Note ton humeur dans le journal pour voir la répartition de tes émotions.",
  statsNoEmotionTitle: "Aucune émotion enregistrée",
  statsNoEntry: "Pas d'entrée ce jour-là",
  statsNoMoodDesc: "Note ton humeur du jour et regarde la courbe se dessiner au fil des jours.",
  statsNoMoodTitle: "Pas encore d'humeur",
  statsOverEntries: "sur {n} entrées",
  statsPercentCompleted: "{pct}% complété",
  statsPerfect: "Parfait",
  statsPremiumInsightToast: "Analyse premium",
  statsPremiumInsightToastDesc: "Débloque l'analyse de ton humeur dominante avec Premium.",
  statsQuote: "La constance vaut plus que l'intensité.",
  statsRanksProgress: "Progression des rangs",
  statsRanksRemaining: "{n} rang(s) à débloquer",
  statsRecentCount: "{n} récentes",
  statsRecentMoods: "Humeurs récentes",
  statsSeeAllRanks: "Voir tous les rangs",
  statsStreakGood: "Belle dynamique d'humeur — continue comme ça.",
  statsStreakLow: "Chaque jour noté est une victoire. Reprends doucement.",
  statsStreakPerfect: "Une semaine complète d'humeur notée ! Impeccable.",
  statsUltimateRank: "Rang ultime",
  statsUnlockWithPremium: "Analyse d'humeur dominante",
  statsUnlockWithPremiumDesc: "Découvre quelle émotion t'accompagne le plus — et comment la désamorcer.",
  statsWeekOvercame: "Tu as traversé cette semaine avec des crises gérées — c'est du vrai muscle.",
  statsWeekPerfect: "Semaine parfaite : 7 jours sans pari. Immense fierté.",
  statsWeekVictory: "Une semaine de gagnée. La tendance est de ton côté.",
  statsWeeklySummary: "Bilan de la semaine",
  statsWeeks5: "5 dernières semaines",
  statsWriteNow: "Écrire maintenant",
  weeklyReportEmpty: "Pas encore de données cette semaine — chaque jour ajouté nourrit ton bilan.",
  volume: "Volume",
  total: "Total",
  ...
  financeGoalMinError: "Entre au moins 1 000 FCFA",
  financeGoalUpdated: "Objectif d'épargne mis à jour \u2728",
  financeAmountFCFA: "Montant en FCFA",
  financeTarget: "Objectif",
  financeTargetAmount: "Montant visé",
...
const en: Dict = {
  ...
  homeMilestoneNext: "Next milestone",
  homeMilestoneIn: "in {n} d",
  homeMilestoneMax: "Ultimate goal reached",
  statsMiniStreak: "Streak",
  statsMiniSaved: "Saved",
  statsMiniLevel: "Level",
  financeGoalDaysLeft: "Goal in {n} d",
  financeAddToGoal: "Add to a goal",
  financeAmountToAdd: "Amount to add",
  financeBeforeVsAfter: "Before / After",
  financeBudgetUpdatedToast: "Budget updated",
  financeBudgetWeekly: "Weekly budget",
  financeCategoryRent: "Rent",
  financeContributeTitle: "Contribute to your goal",
  financeContributedToast: "Contribution added",
  financeCreateFirstGoal: "Create my first goal",
  financeCreateGoal: "New goal",
  financeGoalAddedToast: "Goal created",
  financeGoalDeletedToast: "Goal deleted",
  financeGoalNameRequired: "Give your goal a name",
  financeGoalReachedXP: "Savings goal reached",
  financeGoalReachedToast: "Well done, goal reached!",
  financeIcon: "Icon",
  financeIncome: "Income",
  financeInvalidAmount: "Invalid amount",
  financeMyGoals: "My goals",
  financeNewGoalTitle: "New goal",
  financeNoGoalSet: "No goals yet. Set an amount and watch your savings fill it.",
  financeProgress30Days: "30-day progress",
  financeReached: "reached",
  financeSavingsDistribution: "Savings breakdown",
  financeSavingsStreak: "Savings streak",
  financeUnderstood: "Got it",
  meditationBravo: "Well done!",
  meditationBreathingDoneDesc: "Your session is complete. Your mind is calmer, your brain thanks you.",
  meditationBreathingHint: "Breathe with the circle: inhale as it grows, exhale as it shrinks.",
  meditationCycleProgress: "Cycle {current} of {total}",
  meditationGuidedHint: "Let yourself be guided, breathe at your own pace.",
  meditationMuscleDesc: "Every session strengthens your willpower muscle.",
  meditationPaused: "Paused — resume whenever you like",
  meditationResumePrompt: "Resume when you're ready",
  meditationWhyMeditate: "Why meditate?",
  notifDeniedToast: "Notifications denied — enable them in settings",
  notifEnabledToast: "Notifications enabled",
  communityReserve: "Talk to a professional",
  profileActivities: "{n} activity(ies)",
  legalBackToApp: "Back to app",
  legalZerobetFooter: "Zerobet — Play less, live more",
  privacyTitle: "Privacy Policy",
  privacySubtitle: "How Zerobet protects your data",
  privacyBadge: "100% private",
  privacySection1Title: "Data stored on your phone",
  privacySection1Body1: "Zerobet is designed so your data stays with you. All your information — streak, journal, mood, finances — is stored directly on your device.",
  privacySection1Body2: "We have no access to any of this content.",
  privacySection1Item1: "No personal data is sold",
  privacySection1Item2: "No advertising trackers",
  privacySection1Item3: "No account required",
  privacySection1Item4: "Works offline",
  privacySection2Title: "Optional cloud backup",
  privacySection2Body1: "If you enable sync, a random ID not linked to your identity backs up your progress.",
  privacySection2Body2: "You can disable sync and erase server data anytime from Settings → My data.",
  privacySection3Title: "What we share",
  privacySection3Body1: "Nothing. No data is handed over to third parties, advertisers or data brokers.",
  privacySection3Body2: "The community only shows the nickname you choose.",
  privacySection4Title: "Cookies and trackers",
  privacySection4Body1: "Zerobet uses no advertising cookies or third-party trackers. Only local technical storage keeps your preferences.",
  privacySection5Title: "Your rights",
  privacySection5Body1: "Under GDPR, you have rights over your data:",
  privacySection5Item1: "Access and export all your data",
  privacySection5Item2: "Rectification from the app",
  privacySection5Item3: "Immediate and permanent deletion",
  privacySection5Item4: "Portability via the JSON archive",
  privacySection6Title: "Contact us",
  privacySection6Body1: "A question about your privacy? Write to us, we reply within 48h.",
  termsTitle: "Terms of Use",
  termsSubtitle: "The ground rules — in plain words",
  termsBadge: "2026 Edition",
  termsSection1Title: "Purpose of the service",
  termsSection1Body1: "Zerobet is a support tool to reduce or stop sports betting. It does not replace medical advice or professional treatment.",
  termsSection1Body2: "In case of significant distress, consult a healthcare professional.",
  termsSection2Title: "Using the app",
  termsSection2Body1: "By using Zerobet, you agree to use the app in good faith:",
  termsSection2Item1: "Do not bypass blocking tools",
  termsSection2Item2: "Respect other community members",
  termsSection2Item3: "Do not use the app for illegal purposes",
  termsSection2Item4: "Keep a respectful nickname",
  termsSection3Title: "Health and safety",
  termsSection3Body1: "The statistics shown are estimates based on your entries and do not constitute a diagnosis.",
  termsSection3Body2: "In a crisis, contact a local helpline or someone you trust.",
  termsSection4Title: "Subscriptions and payments",
  termsSection4Body1: "The premium subscription is monthly or yearly, renewable, and can be cancelled anytime from the Subscription screen.",
  termsSection4Body2: "Payments are processed by local providers (Orange Money, MTN, Wave, CinetPay). Zerobet stores no secret codes.",
  termsSection5Title: "Liability",
  termsSection5Body1: "Zerobet is provided “as is”, with no guarantee of results. The app cannot be held liable for decisions made independently of its support.",
  termsSection5Body2: "Zerobet is an independent project, not affiliated with the betting operators mentioned.",
  statsConsistency: "Consistency",
  statsCrisesAvoided: "Crises avoided",
  statsCrisis: "crisis",
  statsCumulativeSavings: "Cumulative savings",
  statsDay: "day",
  statsDaysAgo: "{n}d ago",
  statsDaysWithMood: "Days with mood",
  statsDaysWithoutBet: "Days without betting",
  statsEmotionCount: "{n} emotion(s)",
  statsEntries: "entries",
  statsEntry: "entry",
  statsHeatmap: "Streak calendar",
  statsEmotionDistribution: "Emotion breakdown",
  statsHoursAgo: "{n}h ago",
  statsJournalEntries: "Journal entries",
  statsJustNow: "just now",
  statsLast14Days: "Last 14 days",
  statsLast30Days: "Last 30 days",
  statsLast7Days: "Last 7 days",
  statsMinutesAgo: "{n}min ago",
  statsNextRank: "Next rank",
  statsNoBet: "Bet-free",
  statsNoEmotionDesc: "Log your mood in the journal to see your emotion breakdown.",
  statsNoEmotionTitle: "No emotions logged",
  statsNoEntry: "No entry that day",
  statsNoMoodDesc: "Log today's mood and watch the curve build up day after day.",
  statsNoMoodTitle: "No mood yet",
  statsOverEntries: "out of {n} entries",
  statsPercentCompleted: "{pct}% completed",
  statsPerfect: "Perfect",
  statsPremiumInsightToast: "Premium insight",
  statsPremiumInsightToastDesc: "Unlock your dominant mood analysis with Premium.",
  statsQuote: "Consistency beats intensity.",
  statsRanksProgress: "Rank progress",
  statsRanksRemaining: "{n} rank(s) to unlock",
  statsRecentCount: "{n} recent",
  statsRecentMoods: "Recent moods",
  statsSeeAllRanks: "See all ranks",
  statsStreakGood: "Nice mood momentum — keep it up.",
  statsStreakLow: "Every logged day is a win. Ease back in gently.",
  statsStreakPerfect: "A full week of logged moods! Flawless.",
  statsUltimateRank: "Ultimate rank",
  statsUnlockWithPremium: "Dominant mood analysis",
  statsUnlockWithPremiumDesc: "Discover which emotion follows you most — and how to defuse it.",
  statsWeekOvercame: "You got through this week with managed cravings — that's real strength.",
  statsWeekPerfect: "Perfect week: 7 bet-free days. Immense pride.",
  statsWeekVictory: "Another week won. The trend is on your side.",
  statsWeeklySummary: "Weekly summary",
  statsWeeks5: "Last 5 weeks",
  statsWriteNow: "Write now",
  weeklyReportEmpty: "No data yet this week — each added day feeds your report.",
  volume: "Volume",
  total: "Total",
  ...
  financeGoalMinError: "Enter at least 1,000 FCFA",
  financeGoalUpdated: "Savings goal updated \u2728",
  financeAmountFCFA: "Amount in FCFA",
  financeTarget: "Goal",
  financeTargetAmount: "Target amount",
...
const es: Dict = {
  ...
  homeMilestoneNext: "Próximo hito",
  homeMilestoneIn: "en {n} d",
  homeMilestoneMax: "Objetivo máximo alcanzado",
  statsMiniStreak: "Racha",
  statsMiniSaved: "Ahorro",
  statsMiniLevel: "Nivel",
  financeGoalDaysLeft: "Meta en {n} d",
  financeAddToGoal: "Añadir a una meta",
  financeAmountToAdd: "Monto a añadir",
  financeBeforeVsAfter: "Antes / Después",
  financeBudgetUpdatedToast: "Presupuesto actualizado",
  financeBudgetWeekly: "Presupuesto semanal",
  financeCategoryRent: "Alquiler",
  financeContributeTitle: "Contribuir a tu meta",
  financeContributedToast: "Contribución añadida",
  financeCreateFirstGoal: "Crear mi primera meta",
  financeCreateGoal: "Nueva meta",
  financeGoalAddedToast: "Meta creada",
  financeGoalDeletedToast: "Meta eliminada",
  financeGoalNameRequired: "Dale un nombre a tu meta",
  financeGoalReachedXP: "Meta de ahorro alcanzada",
  financeGoalReachedToast: "¡Bravo, meta alcanzada!",
  financeIcon: "Icono",
  financeIncome: "Ingresos",
  financeInvalidAmount: "Monto inválido",
  financeMyGoals: "Mis metas",
  financeNewGoalTitle: "Nueva meta",
  financeNoGoalSet: "Aún no hay metas. Fíjate un monto y mira cómo se llena tu ahorro.",
  financeProgress30Days: "Progreso de 30 días",
  financeReached: "alcanzadas",
  financeSavingsDistribution: "Reparto del ahorro",
  financeSavingsStreak: "Racha de ahorro",
  financeUnderstood: "Entendido",
  meditationBravo: "¡Bravo!",
  meditationBreathingDoneDesc: "Tu sesión ha terminado. Tu mente está más tranquila, tu cerebro te lo agradece.",
  meditationBreathingHint: "Respira con el círculo: inhala al crecer, exhala al encoger.",
  meditationCycleProgress: "Ciclo {current} de {total}",
  meditationGuidedHint: "Déjate guiar, respira a tu ritmo.",
  meditationMuscleDesc: "Cada sesión fortalece tu músculo de la voluntad.",
  meditationPaused: "En pausa — reanuda cuando quieras",
  meditationResumePrompt: "Reanuda cuando estés listo",
  meditationWhyMeditate: "¿Por qué meditar?",
  notifDeniedToast: "Notificaciones denegadas — actívalas en ajustes",
  notifEnabledToast: "Notificaciones activadas",
  communityReserve: "Hablar con un profesional",
  profileActivities: "{n} actividad(es)",
  legalBackToApp: "Volver a la app",
  legalZerobetFooter: "Zerobet — Juega menos, vive más",
  privacyTitle: "Política de privacidad",
  privacySubtitle: "Cómo Zerobet protege tus datos",
  privacyBadge: "100% privado",
  privacySection1Title: "Datos almacenados en tu teléfono",
  privacySection1Body1: "Zerobet está diseñado para que tus datos se queden contigo. Toda tu información — racha, diario, ánimo, finanzas — se guarda directamente en tu dispositivo.",
  privacySection1Body2: "No tenemos acceso a ninguno de estos contenidos.",
  privacySection1Item1: "No se venden datos personales",
  privacySection1Item2: "Sin rastreadores publicitarios",
  privacySection1Item3: "No se requiere cuenta",
  privacySection1Item4: "Funciona sin conexión",
  privacySection2Title: "Copia de seguridad opcional",
  privacySection2Body1: "Si activas la sincronización, un identificador aleatorio no vinculado a tu identidad guarda tu progreso.",
  privacySection2Body2: "Puedes desactivar la sincronización y borrar los datos del servidor cuando quieras desde Ajustes → Mis datos.",
  privacySection3Title: "Lo que compartimos",
  privacySection3Body1: "Nada. No se cede ningún dato a terceros, anunciantes ni corredores de datos.",
  privacySection3Body2: "La comunidad solo muestra el apodo que elijas.",
  privacySection4Title: "Cookies y rastreadores",
  privacySection4Body1: "Zerobet no usa cookies publicitarias ni rastreadores de terceros. Solo un almacenamiento local técnico guarda tus preferencias.",
  privacySection5Title: "Tus derechos",
  privacySection5Body1: "Conforme al RGPD, tienes derechos sobre tus datos:",
  privacySection5Item1: "Acceso y exportación de todos tus datos",
  privacySection5Item2: "Rectificación desde la app",
  privacySection5Item3: "Borrado inmediato y permanente",
  privacySection5Item4: "Portabilidad mediante el archivo JSON",
  privacySection6Title: "Contáctanos",
  privacySection6Body1: "¿Preguntas sobre tu privacidad? Escríbenos, respondemos en 48 h.",
  termsTitle: "Términos de uso",
  termsSubtitle: "Las reglas del juego — en claro",
  termsBadge: "Edición 2026",
  termsSection1Title: "Objeto del servicio",
  termsSection1Body1: "Zerobet es una herramienta de apoyo para reducir o dejar las apuestas deportivas. No sustituye el consejo médico ni el tratamiento profesional.",
  termsSection1Body2: "En caso de malestar importante, consulta a un profesional de la salud.",
  termsSection2Title: "Uso de la aplicación",
  termsSection2Body1: "Al usar Zerobet, te comprometes a usar la app de buena fe:",
  termsSection2Item1: "No eludir las herramientas de bloqueo",
  termsSection2Item2: "Respetar a los demás miembros de la comunidad",
  termsSection2Item3: "No usar la app con fines ilegales",
  termsSection2Item4: "Mantener un apodo respetuoso",
  termsSection3Title: "Salud y seguridad",
  termsSection3Body1: "Las estadísticas mostradas son estimaciones basadas en tus registros y no constituyen un diagnóstico.",
  termsSection3Body2: "En caso de crisis, contacta una línea de ayuda local o una persona de confianza.",
  termsSection4Title: "Suscripciones y pagos",
  termsSection4Body1: "La suscripción premium es mensual o anual, renovable, cancelable en cualquier momento desde la pantalla Suscripción.",
  termsSection4Body2: "Los pagos son procesados por proveedores locales (Orange Money, MTN, Wave, CinetPay). Zerobet no almacena códigos secretos.",
  termsSection5Title: "Responsabilidad",
  termsSection5Body1: "Zerobet se proporciona “tal cual”, sin garantía de resultados. La app no puede ser responsable de decisiones tomadas de forma independiente a su acompañamiento.",
  termsSection5Body2: "Zerobet es un proyecto independiente, sin vínculo con los operadores de apuestas mencionados.",
  statsConsistency: "Constancia",
  statsCrisesAvoided: "Crisis evitadas",
  statsCrisis: "crisis",
  statsCumulativeSavings: "Ahorro acumulado",
  statsDay: "día",
  statsDaysAgo: "hace {n} d",
  statsDaysWithMood: "Días con ánimo",
  statsDaysWithoutBet: "Días sin apostar",
  statsEmotionCount: "{n} emoción(es)",
  statsEntries: "entradas",
  statsEntry: "entrada",
  statsHeatmap: "Calendario de racha",
  statsEmotionDistribution: "Reparto de emociones",
  statsHoursAgo: "hace {n} h",
  statsJournalEntries: "Entradas del diario",
  statsJustNow: "ahora mismo",
  statsLast14Days: "Últimos 14 días",
  statsLast30Days: "Últimos 30 días",
  statsLast7Days: "Últimos 7 días",
  statsMinutesAgo: "hace {n} min",
  statsNextRank: "Próximo rango",
  statsNoBet: "Sin apostar",
  statsNoEmotionDesc: "Registra tu ánimo en el diario para ver el reparto de tus emociones.",
  statsNoEmotionTitle: "Sin emociones registradas",
  statsNoEntry: "Sin entrada ese día",
  statsNoMoodDesc: "Registra tu ánimo de hoy y mira cómo se dibuja la curva día tras día.",
  statsNoMoodTitle: "Aún sin ánimo",
  statsOverEntries: "de {n} entradas",
  statsPercentCompleted: "{pct}% completado",
  statsPerfect: "Perfecto",
  statsPremiumInsightToast: "Análisis premium",
  statsPremiumInsightToastDesc: "Desbloquea el análisis de tu ánimo dominante con Premium.",
  statsQuote: "La constancia vale más que la intensidad.",
  statsRanksProgress: "Progreso de rangos",
  statsRanksRemaining: "{n} rango(s) por desbloquear",
  statsRecentCount: "{n} recientes",
  statsRecentMoods: "Ánimos recientes",
  statsSeeAllRanks: "Ver todos los rangos",
  statsStreakGood: "Buen impulso de ánimo — sigue así.",
  statsStreakLow: "Cada día registrado es una victoria. Retoma con calma.",
  statsStreakPerfect: "¡Una semana completa de ánimos registrados! Impecable.",
  statsUltimateRank: "Rango máximo",
  statsUnlockWithPremium: "Análisis del ánimo dominante",
  statsUnlockWithPremiumDesc: "Descubre qué emoción te acompaña más — y cómo desactivarla.",
  statsWeekOvercame: "Pasaste esta semana con antojos gestionados — eso es fuerza real.",
  statsWeekPerfect: "Semana perfecta: 7 días sin apostar. Un orgullo enorme.",
  statsWeekVictory: "Una semana ganada. La tendencia está de tu lado.",
  statsWeeklySummary: "Resumen semanal",
  statsWeeks5: "Últimas 5 semanas",
  statsWriteNow: "Escribir ahora",
  weeklyReportEmpty: "Aún sin datos esta semana — cada día añadido alimenta tu resumen.",
  volume: "Volumen",
  total: "Total",
  ...
  financeGoalMinError: "Introduce al menos 1.000 FCFA",
  financeGoalUpdated: "Meta de ahorro actualizada \u2728",
  financeAmountFCFA: "Monto en FCFA",
  financeTarget: "Meta",
  financeTargetAmount: "Monto objetivo",
